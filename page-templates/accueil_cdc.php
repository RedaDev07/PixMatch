<?php
/**
 * Template Name: PixMatch - Accueil Créateurs de Contenu
 */

get_header();
?>

<div class="pixmatch-accueil-cdc">
    
    <!-- SECTION HERO AVEC SWITCH -->
    <div style="position: relative; width: 100%; margin-bottom: 40px;">
        <!-- IMAGE D'ACCUEIL -->
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/fichier2.jpg" alt="image accueil" class="image-accueil">
...
<!-- AJOUTE DES <br> POUR DESCENDRE LE SWITCH -->
    <br><br><br>
        ...
        <div class="hero-switch">
            <a href="<?php echo esc_url(home_url('/accueil-particuliers')); ?>" class="switch-btn">Particuliers</a>
            <a href="<?php echo esc_url(home_url('/accueil-createurs')); ?>" class="switch-btn switch-active">Créateurs</a>
        </div>
    </div>
    ...
    <section class="pro-section">
        ...
        <div class="pro-row">
            ...
            <div class="pro-card">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/accueilcdc/portrait1.jpg" alt="Photographe" class="pro-img">
    ...
    <section class="why">
        ...
        <div class="why-row">
            ...
            <div class="why-group">
                ...
                <div class="why-icons">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/accueilcdc/Lightroom.svg" alt="Lightroom" class="why-icon">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/accueilcdc/Photoshop.svg" alt="Photoshop" class="why-icon">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/accueilcdc/Premierepro.svg" alt="Premiere Pro" class="why-icon">
                </div>
            </div>
            ...
            <div class="why-group">
                ...
                <div class="why-payments">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/accueilcdc/Visa.svg" alt="Visa" class="why-pay">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/accueilcdc/Mastercard.png" alt="Mastercard" class="why-pay">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/accueilcdc/Carte.png" alt="Carte bancaire" class="why-pay">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="avis-inner">
                <div class="avis-left">
                    <div class="avis-photo">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/accueilcdc/avisphoto.avif" alt="Photo avis" class="avis-img">
                    </div>
                    <div class="avis-meta">
